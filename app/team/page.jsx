		...
		<>
			<div className="flex items-center justify-center h-screen mb-12 bg-fixed bg-center bg-cover bg-[url('../app/assets/Fitness.jpg')]">
				...
				<div className="p-5 text-white z-[2] mt-[-10rem]">
					<h2 className="text-5xl mt-20 font-bold">About Us</h2>
				...
				<div className="p-5 text-white">
					...
					<div className="grid lg:grid-cols-3 auto-cols-[300px] gap-6 items-center ">
						<div className="font-bold border-2 rounded-xl p-4">
							How we started: The Randash Painting business was
							originated by Adam’s grandfather, Elmer Randash in 1950.
							Elmer was part of the SEABEES in the Navy. While enlisted
							during WW2 he served as an aircraft painter in California.
							He brought his painting skills home after the war concluded
							to start the business in the FM area.
						</div>

						<div className="font-bold border-2 rounded-xl p-4">
							{" "}
							Through the years: In 1985 Dave Randash, Elmer’s son took
							over the business. Dave Randash built up a reputation of
							superior craftsmanship for Randash Painting throughout the
							FM area with years of service. He worked with many big
							builders throughout the area over the years.
						</div>
						<div className="font-bold border-2 rounded-xl p-4">
